...
import com.example.aplicacinftc.Adapters.ListViewAdapter;
...
public class AnadirUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anadir_user);

        mAuth = FirebaseAuth.getInstance();
        mDataBase = FirebaseDatabase.getInstance().getReference();
        mStorage = FirebaseStorage.getInstance().getReference();

        editnombre = (EditText) findViewById(R.id.addNombreUser);
        editapellido = (EditText) findViewById(R.id.addApellidosUser);
        editemail = (EditText) findViewById(R.id.addCorreoUser);
        editedad = (EditText) findViewById(R.id.addEdadUser);
        editcontra = (EditText) findViewById(R.id.addPasswordUser);
        editrepetircontra = (EditText) findViewById(R.id.addRepeatPasswordUser);

        botonfoto = (Button) findViewById(R.id.buttonAddFotoUser);
        botonadd  = (Button) findViewById(R.id.buttonAddUser);

        spinnerRol = (Spinner) findViewById(R.id.spinnerRol);
        spinnerGrupo = (Spinner) findViewById(R.id.spinnerGrupo);

        listView = (ListView) findViewById(R.id.ListaAsignaturas);
        registerForContextMenu(this.listView);


        asigs = new ArrayList<Asignaturas>();
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()){
                    ...
                    for (DataSnapshot ds: dataSnapshot.getChildren()){
                        ...
                        Asignaturas getasigs= new Asignaturas(nombre,curso,imagen,descripcion,id);
                        asigs.add(getasigs);
        ...
        mAuth.createUserWithEmailAndPassword(email, contra).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    User user = new User(email, nombre, apellido, edad, foto, recordar,rol,grupo,asignaturas,idUser);
